using System;
using RGeos.Converters.WellKnownBinary;
using RGeos.Converters.WellKnownText;
...
namespace RGeos.Geometries
{
    ...
    public abstract class Geometry : IGeometry, IEquatable<Geometry>
    {
        ...
        /// </summary>
        public abstract RGeos.Geometries.Geometry Boundary();
        ...
        /// <returns></returns>
        public static RGeos.Geometries.Geometry GeomFromText(string WKT)
        {
        ...
        /// <returns></returns>
        public static RGeos.Geometries.Geometry GeomFromWKB(byte[] WKB)
        {
