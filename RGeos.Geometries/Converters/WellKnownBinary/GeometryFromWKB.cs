...
//
// This file is part of RGeos.
// RGeos is free software; you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
// the Free Software Foundation; either version 2 of the License, or
// (at your option) any later version.
// 
// RGeos is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
// GNU Lesser General Public License for more details.

// You should have received a copy of the GNU Lesser General Public License
// along with RGeos; if not, write to the Free Software
...
{
    /// <summary>
    ///  Converts Well-known Binary representations to a <see cref="RGeos.Geometries.Geometry"/> instance.
    /// </summary>
    /// <remarks>
    /// <para>The Well-known Binary Representation for <see cref="RGeos.Geometries.Geometry"/> (WKBGeometry) provides a portable 
    /// representation of a <see cref="RGeos.Geometries.Geometry"/> value as a contiguous stream of bytes. It permits <see cref="RGeos.Geometries.Geometry"/> 
    /// values to be exchanged between an ODBC client and an SQL database in binary form.</para>
    /// <para>The Well-known Binary Representation for <see cref="RGeos.Geometries.Geometry"/> is obtained by serializing a <see cref="RGeos.Geometries.Geometry"/>
    ...
    {
        /// <summary>
        /// Creates a <see cref="RGeos.Geometries.Geometry"/> from the supplied byte[] containing the Well-known Binary representation.
        /// </summary>
        /// <param name="bytes">byte[] containing the Well-known Binary representation.</param>
        /// <returns>A <see cref="RGeos.Geometries.Geometry"/> bases on the supplied Well-known Binary representation.</returns>
        public static RGeos.Geometries.Geometry Parse(byte[] bytes)
        {
        ...
        /// <summary>
        /// Creates a <see cref="RGeos.Geometries.Geometry"/> based on the Well-known binary representation.
        /// </summary>
        ...
        /// <returns>A <see cref="RGeos.Geometries.Geometry"/> based on the Well-known binary representation.</returns>
        public static RGeos.Geometries.Geometry Parse(BinaryReader reader)
        {
        ...
        private static RGeos.Geometries.Geometry CreateWKBGeometryCollection(BinaryReader reader, WkbByteOrder byteOrder)
        {
