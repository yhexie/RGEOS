...
namespace RGeos.Measure
{
    ...
    public class RAreaMeasure
    {
        ...
        public static int orientation2D_Polygon(int n, RPoint[] V)
        {
            ...
            if (rmin == 0)
                return RMath.isLeft(V[n - 1], V[0], V[1]);
            else
                return RMath.isLeft(V[rmin - 1], V[rmin], V[rmin + 1]);
        }
        //===================================================================
        //2D空间多边形面积
        ...
        public static double area2D_Polygon(int n, RPoint[] V)
        {
            double area = 0;
            int i, j, k;     // indices
