...
namespace RGeos.Carto
{
    ...
    /// </summary>
    public class AffineTransformation2D : ITransformation
    {
        ...
        public AffineTransformation2D(double[] array)
        {
            if (array.Length != 6)
        ...
        public RgPoint ImageToGround(RgPoint imagePoint)
        {
            RgPoint groundPoint = new RgPoint();
