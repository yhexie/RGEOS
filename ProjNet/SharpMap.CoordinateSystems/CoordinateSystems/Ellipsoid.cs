...
namespace ProjNet.CoordinateSystems
{
    ...
    public class Ellipsoid : Info, IEllipsoid
    {
        ...
        /// <param name="inverseFlattening">反扁率Inverse flattening</param>
        /// <param name="isIvfDefinitive">是否定义了反扁率Inverse Flattening is definitive for this ellipsoid (Semi-minor axis will be overridden)</param>
        ...
        public static Ellipsoid WGS84
        {
            get
            {
                return new Ellipsoid(6378137, 0, 298.257223563, true, LinearUnit.Metre, "WGS 84", "EPSG", 7030, "WGS84", "", "Inverse flattening derived from four defining parameters (semi-major axis; C20 = -484.16685*10e-6; earth's angular velocity w = 7292115e11 rad/sec; gravitational constant GM = 3986005e8 m*m*m/s/s).");
            }
        }
